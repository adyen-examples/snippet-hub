...
public class IndividualOnboarding {
    ...
    public LegalEntity run() throws IOException, ApiException {
        ...
        Document documentForLegalEntity = createDocumentForLegalEntity(legalEntity.getId());
        ...
        LOGGER.info("IndividualOnboarding has completed. Legal Entity ID: {}", legalEntity.getId());

        return legalEntity;

    }

    LegalEntity createLegalEntity() throws IOException, ApiException {
    ...
    Document createDocumentForLegalEntity(String legalEntityId) throws ApiException, IOException {
